<template>
  <div>
    ...
    <el-dialog append-to-body :title="title" :visible.sync="visible" :close-on-click-modal="false" :close-on-press-escape="false" width="500px" :before-close="onDialogCancle">
      <el-form ref="banner" :model="bannerForm" label-position="right" label-width="50px">
          ...
          <el-form-item label="轮播图链接" prop="bannerUrl" :rules="[{trigger:'blur',message: '密码不能为空',required: true}]">
            <el-input type="text" v-model="bannerForm.bannerUrl" placeholder="请输入密码" autocomplete="off"></el-input>
          </el-form-item>
